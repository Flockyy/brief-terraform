...
# NOTE: Container Apps requires Microsoft.App provider registration which is not available
# Alternative: Use docker-compose locally or Azure Container Instances
...
#       env {
#         name  = "POSTGRES_HOST"
#         value = azurerm_cosmosdb_postgresql_cluster.main.server_names[0].fully_qualified_domain_name
#       }
# 
#       env {
#         name  = "POSTGRES_PORT"
